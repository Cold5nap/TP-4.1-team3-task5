<template>
    <div class="container-xxl my-md-4 bd-layout">
        ...
        <div class="row p-3 justify-content-center rounded bg-black-10">
            <div class="col-auto">
                <input type="radio" class="visually-hidden form-check-input" v-model="tab" value="constructor"
                    id="constructorTab">
                <label style="cursor: pointer;" class="form-check-label" for="constructorTab"
                    :class="{ 'badge badge bg-warning text-black': tab === 'constructor' }" @click="">
            ...
            <div class="col-auto">
                <input type="radio" class="visually-hidden form-check-input" v-model="tab" value="order" id="orderTab">
                <label style="cursor: pointer;" class="form-check-label" for="orderTab"
        ...
        <div v-show="tab === 'order'" class="row p-3 justify-content-center">
            <div class="row justify-content-center" v-if="selectedMaterials.length > 0">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <template v-for="material in selectedMaterials">
                            <tr>
                                <td>{{ material.name }}</td>
                ...
                <div class="row justify-content-center rounded bg-black bg-opacity-10">
                    ...
                    <div class="mb-3 col-auto">
                        ...
                        <input type="text" class="form-control" id="nameSurname" placeholder="имя отчество"
                            v-model="nameSurname">
                    </div>
                    <div class="mb-3 col-auto">
            ...
            <div v-if="selectedMaterials.length === 0" class="text-center bg-warning bg-opacity-50 rounded">
        ...
        <div v-show="tab === 'constructor'" id="constructor" class="row p-3 justify-content-center">
            ...
            <div class="col-7">
                <div class="row row-cols-1 row-cols-md-3 g-4 m-0 justify-content-center">
                    <Card v-for="(material, index) in materials" :key="index" :index="index" :material="material"
                        @updateSetupNumber="updateSetupNumber"></Card>
                    ...
                    <button type="button" class="btn btn-warning" @click="tab = 'order'">Перейти к оформлению
                        заказа</button>
                </div>
            ...
            <div class="col-auto text-center">
                ...
                <br>
                <h5>Сумма {{ sum }} руб.</h5>
                <button type="button" class="btn btn-warning" @click="resetAll()">Сбросить выбранное</button>
            </div>
...
export default {
    ...
    methods: {
        ...
        resetCanvas() {
            ...
            this.updateCanvas('/images/shelf.png', 0, 50, 250, 200);
        },
        resetAll() {
