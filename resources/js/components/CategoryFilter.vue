    ...
    <li class="mx-3 m-1">
        ...
        <div class="collapse" :id="'cat-id' + category.id">
            <ul class="list-unstyled small">
                <li class="m-2 mx-3 " v-for="(subcategory, index) in category.child_categories">
                    <input class="form-check-input" type="checkbox" :value="subcategory.id" autocomplete="off"
