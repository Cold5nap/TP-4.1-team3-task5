  ...
  methods: {
      ...
      if (children.length > 0) {
        ...
        for (let key in children) {
          ...
          this.childCategories(
            categories.filter((category) => category.parent_id === children[key].id),
            categories,
            childrenUl
          );
        }
    ...
    category(categories) {
      ...
      for (let key in parents) {
        ...
        this.childCategories(
          categories.filter((category) => category.parent_id === parents[key].id),
          categories,
          ul
        );
      }
