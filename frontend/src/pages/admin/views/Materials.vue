        ...
        <div class="row">
          ...
          <div class="col-3 form-group">
            ...
            <input
              disabled
              type="text"
              placeholder="Сумма за материалы"
              id="sum"
              v-bind:value="number * price"
              class="form-control"
            />
          </div>
      ...
      <table class="table table-sm table-bordered">
        ...
        <tbody>
          <tr v-for="material in materials" :key="material.name">
            ...
            <td>
              <span v-for="category in material.categories" :key="category.name"
                >{{ category.name }}<br
              /></span>
            </td>
            <td>
              <img height="70" v-bind:src="material.image.path" v-bind:alt="material.image.name" />
            </td>
            <td>
...
export default {
  ...
  methods: {
    ...
    storeMaterial() {
      ...
      axios
        .post("/api/adm/materials", formData, {
          headers: {
