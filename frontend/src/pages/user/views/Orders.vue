  ...
  <div class="container">
    ...
    <div v-else class="row justify-content-center">
      <div class="col-auto" v-if="!canEnterCode">
        ...
        />
        <button type="button" class="btn btn-warning" @click="requestCode">
      ...
      <div v-else class="col-auto">
        ...
        <label class="form-control-label" for="code"
          >Введите полученный на указанную почту код</label
        >
        <input type="text" class="form-control" id="code" v-model="code" />
        <button type="button" class="btn btn-warning" @click="getOrderByCode">
